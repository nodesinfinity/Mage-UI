...
const faq = [
  {
    question: "What is mage-ui?",
    answer:
      "mage-ui is a curated collection of hand-crafted animations, effects, and interactions that you can seamlessly integrate into your project with a simple copy and paste.",
  },
  {
    question: "Who is this for?",
    answer:
      "mage-ui is designed for developers of all skill levels, from beginners to professionals, who want to enhance their websites with animations without spending extensive time on development.",
  },
  {
    question: "How much does it cost?",
    answer:
      "mage-ui is completely free and open-source. You can use it in both personal and commercial projects.",
  },
  {
    ...
    answer: (
      <span>
        ...
        engaging and enjoyable. mage-ui offers a diverse collection of{" "}
  ...
  },
  {
    ...
    answer:
      "While you certainly can create animations yourself, using mage-ui saves you time and effort. Plus, you can learn from our implementations and even contribute to improving them.",
  },
  {
    question: "Sounds amazing, how do I use it?",
    answer: (
      <span>
        Simply copy the code snippets provided on the mage-ui website and paste them into your
