...
import AnimatedBeam from "@/mage-ui/background/animated-beam";
import InteractiveGrid from "@/mage-ui/background/interactive-grid";
import AnimatedGradientText from "@/mage-ui/text/animated-gradient-text";
import SplitText from "@/mage-ui/text/split-text";
