...
It will create a new file `glitch-text.tsx` inside the `components/mage-ui/text` directory.

```bash
mkdir -p components/mage-ui/text && touch components/mage-ui/text/glitch-text.tsx
```
...
```jsx file=<rootDir>/mage-ui/text/glitch-text.tsx
