...
date: 2024-06-24
description: Learn how to contribute components to Mage-UI.
---
...
Once you have the project set up, you can start contributing to Mage-UI.

The first step is to generate a new component. You can use the `yarn Mage-UI:new` command to create a new component. This command will ask you the following questions and generate the required files for you.
