...
date: 2024-06-14
description: Guidelines for contributing to Mage-UI.
---

## Component Generation

Use `yarn Mage-UI:new` for creating new components. This command will add some default files. More details can be found in the [contributing components](/docs/contributing/components) documentation.
